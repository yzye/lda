...
class Sampler:
    ...
    def report_topics(self, vocab, outputfilename, limit=100):
        """
    ...
    def sample_probs(self, doc_id, index):
        ...
        for kk in range(self._num_topics):
            ...
            sample_probs[kk] = ((self._doc_counts[doc_id][kk] + alpha[kk])/(sum(self._doc_counts[doc_id].values()) + sum(alpha))) * self._topics.word_in_topic(kk,term)
